...
<div class="wrapper">
	<div id="header">
		...
		<div id="header-left"><span id="title_Menu">Catégories :</span><span id="cattag"><?php wp_nav_menu( array( 'container_class' => 'menu', 'theme_location' => 'header-left', 'walker' => new Imbalance2_Walker_Nav_Menu(), 'depth' => 1 ) ); ?></span></div>
		<div id="header-center"><span id="title_Menu">Tags :<br></span><span id="cattag"><?php imbalance2_tags() ?><br>
		<!--<?php wp_nav_menu( array( 'container_class' => 'menu', 'theme_location' => 'header-center', 'walker' => new Imbalance2_Walker_Nav_Menu(), 'depth' => 1 ) ); ?>--></span></div>
		<div id="header-right"><div id="search">
			<?php get_search_form(); ?>
		</div><?php wp_nav_menu( array( 'container_class' => 'menu', 'theme_location' => 'header-right', 'walker' => new Imbalance2_Walker_Nav_Menu(), 'depth' => 1 ) ); ?></div>
